...
@section('title', __('main.send_all_teachers_notification'))
...
@section('content')
    ...
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">{{ __('main.send_all_teachers_notification') }}</a></li>
        </ul>
    </div>
    <div class="row justify-content-center">
        <div class="col-xs-12 col-md-8">
            <div class="tile">
                <h3 class="tile-title text-center">{{ __('main.send_all_teachers_notification') }}</h3>
