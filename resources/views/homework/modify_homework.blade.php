...
@section('title',  __('main.edit_homework') )
...
@section('content')
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">{{ __('main.edit_homework') }}</a></li>
        </ul>
    </div>
    <div class="row justify-content-center">
        <div class="col-xs-12 col-md-9">
            <div class="tile">
                <h3 class="tile-title text-center">{{ __('main.edit_homework') }}</h3>
                <form action="{{ route('update_homework_data') }}" role="form" method="post" enctype="multipart/form-data" class="image_crop_form game_upload">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="tajweed_link" value="{{ $homework->tajweed_link  }}" required autofocus>
                    </div>
                    <div class="form-group">
                        <label>{{ __('main.tafsir_link') }}</label>
                        <input class="form-control" type="text" name="tafsir_link" value="{{ $homework->tafsir_link }}" required autofocus>
                    </div>
                    <div class="form-group">
