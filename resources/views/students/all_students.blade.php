...
@section('title', __('main.edit_del_student'))
...
@section('content')
    ...
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">{{ __('main.edit_del_student') }}</a></li>
        </ul>
    </div>
    <div class="row justify-content-center">
        <div class="col-xs-12 col-md-12">
            <div class="tile">
                <h3 class="tile-title text-center">{{ __('main.edit_del_student') }}</h3>
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="form-group">
                            <label>{{ __('main.student_search') }}</label>
                            <input type="text" name="name" class="form-control f-size-090" id="find_student" placeholder="{{ __('main.student_search') }}" autocomplete='off'>
                        </div>
                        <div class="form-group">
                            ...
                            <input class="margin-x5-by-lang" type="radio" name="search_by" value="email"> {{ __('main.email') }}
                        </div>
                    </div>
                </div>
