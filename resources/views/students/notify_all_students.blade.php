...
@section('title', __('main.send_all_students_notification'))
...
@section('content')
    ...
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">{{ __('main.send_all_students_notification') }}</a></li>
        </ul>
    </div>
    <div class="row justify-content-center">
        <div class="col-xs-12 col-md-8">
            <div class="tile">
                <h3 class="tile-title text-center">{{ __('main.send_all_students_notification') }}</h3>
                <form action="{{ route('set_notify_all_students') }}" class="login-form" method="post">
                    {{ csrf_field() }}
